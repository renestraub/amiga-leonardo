...
o:		lea	$dff000,a5
		...
		Load	FN_INTROANIM,BobBase,105*512
		Load	FN_INTROBACK,page1,79*512

		bsr	ConvertPic

		Load	FN_INTROSONG,SongBase,123*512
		move.l	#SongBase,SongPtr

		Load	FN_INTROFX,FxBase,120*512
...
Quit:		clr.l	Window1+2
		...
		move.w	#$000f,$dff096	; Audio DMA off
		bsr	RemInt

Ende:	;;	move.l	#$420,$dff080
		moveq	#0,d0
		rts
