	...
	XDEF	AnzBob,BobList
	XDEF	PosX,PosY,MSpr1,MSpr2,MSpr3,MSpr4
...
CopyOneLine:
	move	(A1),(A3)		;(1.Word/1.Plane) -> (1.Sprite/1.Plane)
	move	128(A1),2(A3)		;(1.Word/2.Plane) -> (1.Sprite/2.Plane)
	move	256(A1),(A4)		;(1.Word/3.Plane) -> (2.Sprite/1.Plane)
	move	384(A1),2(A4)		;(1.Word/4.Plane) -> (2.Sprite/2.Plane)


	move	2(A1),(A5)		;(2.Word/1.Plane) -> (3.Sprite/1.Plane)
	move	130(A1),2(A5)		;(2.Word/2.Plane) -> (3.Sprite/2.Plane)
	move	258(A1),(A6)		;(2.Word/3.Plane) -> (4.Sprite/1.Plane)
	move	386(A1),2(A6)		;(2.Word/4.Plane) -> (4.Sprite/2.Plane)
	add.l	d4,a3
	add.l	d4,a4
	add.l	d4,a5
	add.l	d4,a6
