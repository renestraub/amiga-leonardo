	...
	XDEF	OutOfMemory,Fin,back,MenuInt,InitDisk
	...
	XDEF	CheckBonus,BPage,FS_Ende,FS_GameOver,MemoryHeader,GetName2
	...
	XDEF	Read,Write,FS_Caught,FS_Hi,FxBase
	...
	FS_BigFile:	EQU	0*512
	FS_Menu:	EQU	333*512
	FS_Caught:	EQU	412*512
	FS_Hi:		EQU	446*512
	FS_Ende:	EQU	447*512
	FS_Help:	EQU	540*512
	FS_GameOver:	EQU	606*512
	FS_Fx:		EQU	623*512
...
c3:		LoadFile	FxBase,FS_Fx,43*512
c4:		LoadCruFile	SongBase,FS_BigFile,333*512
c11:		LoadFile	hilist,FS_Hi,512
...
c10:		LoadFile	page1,FS_Menu,40448
...
14$:		cmp		#2,YPos
		...
		LoadCruFile	page2,FS_Help,66*512
		lea		HiColors2+2,a0
...
Begin2:		moveq		#1,d0
		...
		move.l		#$d800,MemoryHeader
		move.l		#$d800+$3000,MemoryHeader+4
		bsr		InitAlloc
		bsr		InitVars
		bsr		ClearPages
		bsr		SetColors
...
ScrollText:	DC.B	'    LEONARDO    ',-1,200
		...
		DC.B	'    '
		DC.B	'USING SOUND FX          '
		DC.B	'ADDITIONAL PROGRAMMING :   CHRIS HALLER   ',-1,150
		DC.B	'          '
		DC.B	'   CHRISTIAN WEBER  ',-1,100
		DC.B	'          '
		DC.B	'LEVEL DESIGN :    RETO STRAUB   ',-1,100
		DC.B	'          '
		DC.B	'PRODUCER   :     HEINZ LUEM    ',-1,100
		DC.B	'          '
		DC.B	0
