	...
	XDEF	KeyBoard,Button,MenuInt,GetKey,Read,Write,FS_Caught,FS_Hi
	XDEF	_GetJoy,_SetSprPos,ShowBonus,Bonus,FirstDefs,CheckBonus
	XDEF	BPage,FS_Ende,FS_GameOver,GetName2,StartLevel,ShowPerfect
...
ShowEndGame:	bsr		ClearSpr
		...
		LoadCruFile	page2,FS_Ende,93*512
...
ShowGameOver:	moveq		#4,d0
		...
		bsr		ClearSpr
		LoadCruFile	page2,FS_GameOver,17*512
...
ShowLivesLeft:	bsr		ClearSpr
		LoadCruFile	page2,FS_Caught,34*512
c34:
		lea		page2+10,a3
		lea		page2+5864,a4
...
28$:
		lea		CheatLevelText,a1
		bra		29$
26$:	
		lea		StartLevelText,a1
29$:
		bsr		PrintText2		
...
EndGameText:		dc.l	End1,End2,End3,End4,End5,End6,End7,0
...
Ch1:			dc.b	40,80,'YOU FOUND THE',0
Ch2:			dc.b	70,105,'SECRET OF',0
...
Nl1:			dc.b	65,100,'NEXT LEVEL',0

End1:			dc.b	20,10,'CONGRATULATIONS',0
End2:			dc.b	0,30,'YOU BROUGHT BACK',0
End3:			dc.b	0,50,'ALL PICTURES AND',0
End4:			dc.b	0,70,'CAN NOW LEAVE',0
End5:			dc.b	0,90,'THIS GAME',0
End6:			dc.b	30,120,'SPECIAL THANKS',0
End7:			dc.b	30,140,'FOR PLAYING',0
End8:			dc.b	30,160,'LEONARDO',0

To1:			dc.b	65,100,'OUT OF TIME',0

Bo1:			dc.b	95,90,'ENTERING',0
Bo2:			dc.b	65,120,'BONUS-LEVEL',0
